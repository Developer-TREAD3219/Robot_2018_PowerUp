...
public class RobotMap {
    ...
    public static DoubleSolenoid leftDriveShifter;
    public static DoubleSolenoid rightDriveShifter;
    ...
    public static void init() {
        ...
        leftDriveShifter = new DoubleSolenoid(0, 1);
        rightDriveShifter = new DoubleSolenoid(2, 3);
    }
}
