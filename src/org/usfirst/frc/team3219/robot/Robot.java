...
public class Robot extends TimedRobot {
	...
	public static SendableChooser<StartPosition> startPositionChooser = new SendableChooser<>();
	public static SendableChooser<Strategy> strategyChooser = new SendableChooser<>();
	...
	public void robotInit() {
		...
		Command autoForward = new AutoForward(DISTANCE_TO_AUTOLINE);
		...
		strategyChooser.addDefault("AutoLine", Strategy.line);
		strategyChooser.addObject("AutoLine & Switch", Strategy.line_switch);
		strategyChooser.addObject("AutoLine & Scale", Strategy.line_scale);
	...
	public void autonomousPeriodic() {
		Scheduler.getInstance().run();
		Sensors.heading(); // to update SmartDashboard
	}
