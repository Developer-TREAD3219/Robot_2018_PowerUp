...
public class DriveTrain extends Subsystem {
	private static final int MOTOR_CURRENT_MAXIMUM = 60;
	private static final int CURRENT_LIMIT_TIMEOUT = 100;
	private static final int MINIMUM_CURRENT_LIMIT = 1;
	...
	public void morePowerScotty(boolean more) {
		if (more) {
			this.backLeft.configContinuousCurrentLimit(MOTOR_CURRENT_MAXIMUM, CURRENT_LIMIT_TIMEOUT);
			this.backRight.configContinuousCurrentLimit(MOTOR_CURRENT_MAXIMUM, CURRENT_LIMIT_TIMEOUT);
		} else {
			this.backLeft.configContinuousCurrentLimit(MINIMUM_CURRENT_LIMIT, CURRENT_LIMIT_TIMEOUT);
			this.backRight.configContinuousCurrentLimit(MINIMUM_CURRENT_LIMIT, CURRENT_LIMIT_TIMEOUT);

		}
		SmartDashboard.putBoolean("morepower", more);
	}
